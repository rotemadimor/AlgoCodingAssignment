...
static void printMenu() {
    ...
    std::cout << "3) Run Question 3 (BFS - worst case)\n";
    std::cout << "4) Run Question 4 (BFS - expected case with sampling)\n";
    std::cout << "9) Run All\n";
    std::cout << "0) Exit\n";
    std::cout << "Choose: ";
}
...
int main() {
    while (true) {
        ...
        case 3:
            std::cout << "=== Question 3: BFS Strategy (Worst Case) ===\n";
            question_3();
            std::cout << "\n";
            break;

        case 4:
            std::cout << "=== Question 4: BFS Strategy (Expected Case with Sampling) ===\n";
            question_4();
            std::cout << "\n";
            break;
